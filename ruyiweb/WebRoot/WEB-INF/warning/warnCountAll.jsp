...
Highcharts.setOptions({
  ...
  $(function () {
   ...
   <div class="tab-pane fade  in active" id="allpanel">
<form method="POST" class="form" action="${pageContext.request.contextPath}/warn_countAll">
...
<div id="allchart"></div>
<c:if test="${not empty session.warningList3 }">
<script >
Highcharts.setOptions({
    lang: {
        printChart: '打印图表',
